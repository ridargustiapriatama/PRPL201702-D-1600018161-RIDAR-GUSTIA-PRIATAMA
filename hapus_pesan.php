...
$sql="delete from pesan where id_customer='$id_customer'";

if ($konek->query($sql)) {
			echo "<font size='5px' color='##00FFFF'>Data Booking berhasil dihapus! </font></br>";
		}
		else{
			echo "<font size='5px' color='#ff0000'>Data Booking gagal dihapus karena :" .$konek->error."</font></br>";
		}
$konek->close();
